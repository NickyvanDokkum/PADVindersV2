...
public class EventList : MonoBehaviour {
    ...
    private static readonly List<Event> events = new List<Event>() {
        new Event("Damages to your maintenance (heater,fan, etc.)", "Your heater/fan/etc just broke. You tell your landlord about this and he says you need to pay it yourself."),
        ...
        new Event("You need to pay extra service fees which you didnt ask for and didnt know about", "Your landlord tells you you knew about the costs but you cant find anything back in your documents or you want to remove them but you cant because the services are essential"),
